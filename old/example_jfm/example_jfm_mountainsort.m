function example_jfm_mountainsort
...
addpath(basepath);
opts.raw_dat=[basepath,'/../ms11d45A_jfm/ms11d45.dat'];
opts.channels=[37:52,68,69];
opts.adjacency_radius=2;
opts.raw_mda=[basepath,'/../ms11d45A_jfm/ms11d45A_pre.mda'];
opts.locations=[basepath,'/../ms11d45A_jfm/locations.mda'];
...
opts.working_path=[basepath,'/../ms11d45A_jfm/working'];
opts.output_path=[basepath,'/../ms11d45A_jfm/output'];
opts.prewhiten=1;
