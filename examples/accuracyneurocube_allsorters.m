% accuracy vs ground truth for NeuroCube simulations, for various sorters
% Barnett 4/26/16

clear; d = grab_neurocube_dataset(1);
...
for i=testlist
  ...
  fprintf('Neurocube-accuracy of sorter %s done: fk accuracies vs label k are... \n',snames{i})
...
disp('ALL SORTERS NEUROCUBE-ACCURACY SUMMARY:')
