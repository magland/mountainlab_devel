...
tmpin='/tmp/dbscan_patwary_tmp.bin';
...
s = sprintf('%s/dbscan_patwary_mex/omp_dbscan -i %s -b -m %d -e %.15g -t %d -o %s',fileparts(mfilename('fullpath')),tmpin,minpts,eps,ncpu,tmpout);
