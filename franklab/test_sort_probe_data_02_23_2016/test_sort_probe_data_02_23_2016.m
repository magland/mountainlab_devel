function test_sort_probe_data_02_23_2016

close all;

mfile_path=fileparts(mfilename('fullpath'));
addpath(sprintf('%s/../sort_001_multichannel',mfile_path));
...
%sort_opts.debug_channels=[1:6];
sort_001_multichannel([path0,'/raw.mda'],path0,sort_opts);
