function test_sort003_on_demotimeseries

close all;

%%%% Set up paths
mfile_path=fileparts(mfilename('fullpath'));
addpath([mfile_path,'/../franklab/sort_003_multichannel']);
raw_path=[mfile_path,'/../unit_tests/demo_data/demotimeseries.mda'];
%if ~exist(raw_path), writedemotimeseries; end
writedemotimeseries;

mfile_path=fileparts(mfilename('fullpath'));
output_path=[mfile_path,'/output_sort003_on_demotimeseries'];
...
[firings_path,pre_path]=sort_003_multichannel(raw_path,output_path,sort_opts);
